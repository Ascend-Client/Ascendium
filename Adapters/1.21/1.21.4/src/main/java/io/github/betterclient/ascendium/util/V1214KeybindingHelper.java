...
public class V1214KeybindingHelper extends KeyBinding implements KeybindHelper {
    ...
    public V1214KeybindingHelper(String translationKey, int code, String category) {
